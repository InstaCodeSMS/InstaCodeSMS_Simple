    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-3">
            <li>
              <a href="https://t.me/simplefaka" target="_blank" rel="noopener noreferrer" 
            ...
            <li>
              <a href="https://facebook.com/simplefaka" target="_blank" rel="noopener noreferrer"
                 class="flex items-center gap-2 text-sm opacity-70 hover:opacity-100 transition-opacity">
            ...
            <li>
              <a href="https://twitter.com/simplefaka" target="_blank" rel="noopener noreferrer"
                 class="flex items-center gap-2 text-sm opacity-70 hover:opacity-100 transition-opacity">
            ...
            <li>
              <a href="https://youtube.com/@simplefaka" target="_blank" rel="noopener noreferrer"
                 class="flex items-center gap-2 text-sm opacity-70 hover:opacity-100 transition-opacity">
